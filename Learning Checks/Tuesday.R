...
data_new <- read_xlsx('../Practice Data/NE_EdSpending_Jan28th_22.xlsx', na='NA')
summary(data_new)
...
# run spaghetti plots
data_new2 %>% 
  ggplot(mapping = aes(x = enroll_raw_NE, y = pp_total_raw_NE, group = district_ID, color = district_ID)) +
  geom_point() +
  # geom_line() +
